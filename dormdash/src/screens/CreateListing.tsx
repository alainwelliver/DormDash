...
export default function CreateListing({ onCancel, onCreated }: Props) {
 ...
 async function handleSubmit() {
   ...
   if (!categoryId) return Alert.alert("Missing category", "Please choose a category.");
 ...
 return (
   ...
   >
     ...
     <View style={styles.toggleContainer}>
       ...
       >
         <Text style={[styles.toggleText, type === "service" && styles.toggleTextActive]}>
           Service
         </Text>
       </TouchableOpacity>
     </View>
       ...
       <View style={{ flexDirection: "row", gap: 10 }}>
         {localImages.map((uri, idx) => (
           ...
           >
             ...
             />
             <Text style={[styles.subtleText, { textAlign: "center", marginTop: 4 }]}>
               #{idx + 1}
             </Text>
           </TouchableOpacity>
         ))}
